...
class CorruptDataSet:
  ...
  def __init__(self, **kwargs):
    ...
    basefunctions.check_is_positive('number_of_mod_records', self.number_of_mod_records)
    basefunctions.check_is_integer('number_of_org_records', self.number_of_org_records)
    basefunctions.check_is_positive('number_of_org_records', self.number_of_org_records)
